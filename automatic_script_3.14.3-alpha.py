...
def DoTranslate(cookie):
    ...
    #4 SuSE
    elif "SuSE Update for" in en_name:
        APPandID = re.findall(r"SuSE Update for (.*)",en_name)[0]
    ...
    #5 Ubuntu/RedHat/Mandriva
    elif "Ubuntu Update for " in en_name or "RedHat Update for" in en_name or "Mandriva Update for" in en_name:
